...
export const GameOverScreen = ({ gameState, onRestart, onHome }: GameOverScreenProps) => {
  ...
  return (
    ...
    >
      <motion.div
        className="bg-gradient-to-b from-stone-900 to-stone-950 rounded-3xl p-8 max-w-md w-full mx-4 border border-gold/30 shadow-2xl"
      ...
      >
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gold">Journey Complete</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          >
            ...
            <div className="text-2xl font-bold text-white">{Math.floor(gameState.distance)}m</div>
        ...
        {/* Words learned */}
        <motion.div
          className="text-center mb-6 py-3 bg-emerald-900/30 rounded-xl border border-emerald-500/30"
          initial={{ y: 20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
