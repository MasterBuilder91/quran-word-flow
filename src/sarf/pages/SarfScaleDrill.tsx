...
import { Shuffle, Zap, BookOpen } from 'lucide-react';
...
const SarfScaleDrill = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <PageSEO title="Scale Drill" description="Practice Arabic verb conjugation patterns with randomized drills across all verb scales and tenses." path="/sarf/scale-drill" />
      <Header />
      <div className="flex-1 pt-20">
        <div className="container max-w-lg mx-auto py-6 px-5">
        ...
        <main className="container max-w-lg mx-auto px-5 pb-6">
