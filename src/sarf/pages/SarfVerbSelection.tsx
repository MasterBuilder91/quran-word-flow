...
const SarfVerbSelection = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <PageSEO title="Verb Library" description="Browse and search 120+ Arabic verbs for conjugation practice. Filter by Quranic usage and drill any verb." path="/sarf/verbs" />
      <Header />
      <div className="pt-20">
